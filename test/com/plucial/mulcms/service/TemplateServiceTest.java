...
public class TemplateServiceTest extends AppEngineTestCase {
    ...
    public void initialize() {
        ...
        WidgetTemplateService.put("about parts1", new JsoupService("<html><body></body></html>").getDoc(), "#aaa");
        WidgetTemplateService.put("about parts2", new JsoupService("<html><body></body></html>").getDoc(), "#aaa");
    }
