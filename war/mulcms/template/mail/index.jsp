	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<h2 class="page-header"><i class="fa fa-object-group"></i> メールテンプレート管理</h2>
				
				<div class="row">
					<div>
						<div class="col-md-2">
							<a href="/mulcms/template/mail/add" class="btn btn-primary btn-block margin-bottom"><i class="fa fa-plus"></i> 追加</a>
						</div>
					</div>
							...
							<div class="col-md-4">
								<div class="info-box">
									<div class="box-tools pull-right">
										<a class="btn btn-box-tool" href="/mulcms/template/delete?keyString=<%=temp.getKey().getName() %>&type=mail"><i class="fa fa-times"></i></a>
									</div>
									...
									<div class="info-box-content">
										...
										<span class="info-box-number"><a href="/mulcms/template/mail/edit?keyString=<%=temp.getKey().getName() %>"><%=temp.getName() %></a></span>
